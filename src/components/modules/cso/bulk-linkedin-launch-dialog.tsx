...
export function BulkLinkedInLaunchDialog({ workspaceId, open, onClose, onLaunched }: Props) {
  ...
  const [connectNote, setConnectNote] = useState(
    "Bonjour {{prénom}},\n\nJ'ai vu ton profil et je pense qu'il y a une belle synergie entre nos projets. Je serais ravi d'échanger !"
  );
  ...
  function insertVar(field: "note" | "followup", variable: string) {
    if (field === "note") {
      setConnectNote((v) => v + variable);
    } else {
